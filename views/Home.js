...
import { db } from '../config/FireBaseConfig'; // Asegúrate de que la ruta de configuración sea correcta
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useFocusEffect } from '@react-navigation/native';
import LoadingScreen from './LoadingScreen'; // Importación de LoadingScreen

const Home = ({ navigation }) => {
  const [selectedTab, setSelectedTab] = useState('Buzos'); // Pestaña por defecto
  ...
  const GetSliders = async (category) => {
    ...
    console.log('Productos cargados:', sliders); // Verifica los productos cargados
