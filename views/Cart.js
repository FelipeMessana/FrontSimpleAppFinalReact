...
const fetchCartItems = async () => {
  ...
  const handleCheckout = () => {
    const phoneNumber = '+5492944144412'; 
...
const styles = StyleSheet.create({
  ...
  darkText: { color: '#fff' },
  lightText: { color: '#333' },
  deleteButton: { backgroundColor: '#8B6A60', padding: 10, borderRadius: 5, marginTop: 10 },
  ...
  darkFixedButtonContainer: { backgroundColor: '#2D2D2D', borderTopColor: '#555' },
  ...
  purchaseButton: { backgroundColor: '#8B6A60', padding: 15, borderRadius: 5, alignItems: 'center' },
